...
export function ReasoningBasic() {
  const reasoningText = `Hang tight my guy. We’re drafting a press release: ‘Minor mechanical issue en route to greatness.’ Remember, champions don’t walk—unless it’s the runway. See you courtside.`;
  return (
    <Reasoning>
    ...
    >
      ...
      >
        <div className="flex items-end justify-end gap-3">
          ...
          >
            <p className="text-sm">
            Yo bro, the Lambo’s makin that weird noise again. Can you call the dealer? I can’t pull up to econ in a loaner, that’s bad for the brand. Also, do we still gotta go D1 or can I just declare now?
            </p>
          </motion.div>
        ...
        <div className="flex items-start gap-2">
          <div className="flex items-center bg-background rounded-full size-10 flex-shrink-0 justify-center shadow-[0_0_10px_rgba(0,0,0,0.05)] border border-border">
            <Image src="/az12preplogo.webp" alt="AZ12Prep" width={40} height={40} />
          </div>
